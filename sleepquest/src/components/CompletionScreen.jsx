  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-slate-100 dark:from-slate-900 dark:via-indigo-950 dark:to-slate-900 flex flex-col items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        {/* Token reminder */}
        <div
          className="mt-6 text-slate-400 dark:text-slate-600 text-xs transition-colors duration-300"
          style={{ direction: "ltr" }}
        >
...
function SuccessIcon() {
  return (
    <div className="mb-8">
      <div className="inline-flex items-center justify-center w-28 h-28 rounded-full bg-linear-to-br from-green-500 to-emerald-600 shadow-2xl shadow-green-500/40 animate-bounce-slow">
        <svg
  ...
  return (
    <div className="mt-8 p-4 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/30 rounded-xl transition-colors duration-300">
      <p className="text-indigo-600 dark:text-indigo-300 text-sm transition-colors duration-300">
        ⏰ חזור מחר כדי להמשיך את הרצף שלך!
        <br />
        <span className="text-indigo-500 dark:text-indigo-400/70 transition-colors duration-300">
          היומן הבא יהיה זמין לאחר חצות.
        </span>
      </p>
    </div>
  );
