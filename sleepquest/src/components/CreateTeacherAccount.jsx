        ...
        <div className="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/30 rounded-lg p-6 text-right">
          ...
          <ul className="text-sm text-blue-800 dark:text-blue-400 space-y-2">
            <li className="flex gap-2 justify-end">
              <span>יצור מורה עם או בלי הקצאת כיתה</span>
              <span>✅</span>
            </li>
            <li className="flex gap-2 justify-end">
              <span>הקצאת כיתה היא לחלוטין אופציונלית</span>
              <span>✅</span>
            </li>
            <li className="flex gap-2 justify-end">
              <span>דוא״ל וסיסמה נדרשים לאימות</span>
              <span>✅</span>
            </li>
            <li className="flex gap-2 justify-end">
              <span>המורה מקבל קודים כאשר נוצרת כיתה</span>
              <span>✅</span>
            </li>
            <li className="flex gap-2 justify-end">
